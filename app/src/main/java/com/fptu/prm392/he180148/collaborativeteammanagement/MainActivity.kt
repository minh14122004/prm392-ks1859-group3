package com.fptu.prm392.he180148.collaborativeteammanagement
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId){
            ...
            R.id.nav_my_tasks -> {
                Activity.startActivity(Intent(this, MyTasksActivity::class.java))
            }
            R.id.nav_find_projects -> {
                Activity.startActivity(Intent(this, FindProjectsActivity::class.java))
            }
            R.id.nav_sign_out -> {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        }else if (resultCode == Activity.RESULT_OK && requestCode == CREAT_BOARD_REQUEST_CODE){
